    ...
    <div className="huntr-app-shell">
      ...
      <div className="huntr-main">
        ...
        <div className="huntr-page-content">
          {activeCompany && activeCompany.status === "rejected" && pathname !== "/company" ? (
            <div className="huntr-rejected-gate" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", textAlign: "center", background: "var(--ui-bg-card)", border: "1px solid var(--ui-border)", borderRadius: "12px", boxShadow: "0 4px 20px rgba(0,0,0,0.15)", gap: "20px", padding: "48px 32px" }}>
              <div style={{ width: 72, height: 72, borderRadius: "18px", background: "rgba(239, 68, 68, 0.1)", border: "1px solid rgba(239, 68, 68, 0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#ef4444" }}>
                <Building2 size={36} />
              </div>
              <div style={{ maxWidth: 460 }}>
                <h2 style={{ fontSize: "20px", fontWeight: 700, color: "#ef4444", margin: "0 0 8px", letterSpacing: "-0.3px" }}>Pendaftaran Perusahaan Ditolak</h2>
                <p style={{ fontSize: "13px", color: "var(--ui-text-secondary)", lineHeight: "1.6", margin: 0 }}>
                  Workspace untuk <strong>{activeCompany.name}</strong> ditolak oleh tim admin.
                  {activeCompany.verification_notes ? ` Alasan: "${activeCompany.verification_notes}"` : " Silakan periksa kembali data legalitas dan daftarkan ulang profil perusahaan Anda."}
                </p>
              </div>
              <div className="huntr-rejected-gate-actions" style={{ display: "flex", gap: "10px" }}>
                <button onClick={() => navigate("/company")} style={{ padding: "10px 22px", borderRadius: "10px", background: "linear-gradient(135deg, #ef4444, #dc2626)", border: "none", color: "#fff", fontWeight: 600, fontSize: "13px", cursor: "pointer", boxShadow: "0 4px 16px rgba(239,68,68,0.25)" }}>
